...
@section('content_view')
    <div class="card">
        ...
        <div class="card-body">
            <form
                action="{{ route('horarios.update',$course->id) }}"
                method="POST">
                    ...
                    <div class="form-row mb-1" id="CourseDaysDiv">
                        ...
                        <div class="col-3">
                            <input
                                ...
                                min="{{date('Y-m-d')}}"
                                value="{{old('dia1',$course->classDays[0]->get_iSO_date_format)}}"
                                required>
                        </div>
                        <div class="col-3">
                            <input 
                                ...
                                class="w-100 form-control"
                                step="900"
                                value="{{old('hora1Inicio',$course->classDays[0]->get_start_date)}}"
                                required>
                        </div>
                        <div class="col-3">
                            <input 
                                ...
                                class="w-100 form-control"
                                step="900"
                                value="{{old('hora1Fin',$course->classDays[0]->get_end_date)}}"
                                required>
                        </div>
                        ...
                        <div class="col-9 mt-2">
                            <input
                                ...
                                class="form-control"
                                value="{{old('nombreInstructor1',$course->classDays[0]->name_instructor)}}"
                                required>
                        </div> --}}
                    </div>
                    <input
        ...
        @endphp
        <script>
            let oldData = <?= json_encode($oldData); ?>;
        </script>
        {{-- Add and remove days --}}
